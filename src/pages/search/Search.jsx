  ...
  return (
    <div className="container mx-auto p-4  dark:text-white min-h-screen">
      ...
      >
        ...
        <button
          type="submit"
          className="px-6 py-4 bg-blue-500 rounded-e-md z-[1] text-white hover:bg-blue-600 dark:bg-blue-700 dark:hover:bg-blue-800"
        >
          <CiSearch size={20} />
        </button>
      </form>
      ...
      <div className="mt-5">
        {!data?.total_results && (
          <p className="search-info text-center text-gray-600 dark:text-gray-400">
            {t("search.info")}
          </p>
        )}
      </div>
